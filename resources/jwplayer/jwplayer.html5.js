...
(function (h) {
    ...
    h.timeFormat = function (b) {
        if (0 < b) {
            var a = Math.floor(b / 3600), e = Math.floor((b - 3600 * a) / 60);
            b = Math.floor(b % 60);
    ...
    h.bounds = function (b) {
        ...
        if (b.getBoundingClientRect) {
            ...
            do a.left += b.offsetLeft | 0, a.top += b.offsetTop | 0; while (b = b.offsetParent);
...
(function (h) {
    var k = h.stretching = {NONE: "none", FILL: "fill", UNIFORM: "uniform", EXACTFIT: "exactfit"};
    ...
    h.stretch = function (b, a, e, g, c, d) {
        ...
        b = b || k.UNIFORM;
        var f = 2 * Math.ceil(e / 2) / c, D = 2 * Math.ceil(g / 2) / d, m = "video" === a.tagName.toLowerCase(), s = !1, v = "jw" + b.toLowerCase();
...
(function (h) {
    h.dfxp = function () {
        ...
        this.parse = function (b) {
            ...
            var e = b.split("\x3c/p\x3e"), g = b.split("\x3c/tt:p\x3e"), c = [];
            for (b = 0; b < e.length; b++)0 <= e[b].indexOf("\x3cp") && (e[b] = e[b].substr(e[b].indexOf("\x3cp") + 2).replace(/^\s+/, "").replace(/\s+$/, ""), c.push(e[b]));
            for (b = 0; b < g.length; b++)0 <= g[b].indexOf("\x3ctt:p") && (g[b] = g[b].substr(g[b].indexOf("\x3ctt:p") + 5).replace(/^\s+/, "").replace(/\s+$/, ""), c.push(g[b]));
            e = c;
            for (b = 0; b < e.length; b++) {
                g = e[b];
                c = {};
                try {
                    var d = g.indexOf('begin\x3d"'), g = g.substr(d + 7), d = g.indexOf('" end\x3d"');
                ...
                g = c;
                g.text && (a.push(g), g.end && (a.push({begin: g.end, text: ""}), delete g.end))
            }
...
(function (h) {
    h.srt = function () {
        var k = jwplayer.utils, b = k.seconds;
        this.parse = function (a, e) {
            ...
            for (var d = 0; d < c.length; d++)if ("WEBVTT" != c[d]) {
                ...
                try {
                    ...
                    if (m[h + 1]) {
                        f.text = m[h + 1];
                        for (h += 2; h < m.length; h++)f.text += "\x3cbr/\x3e" +
                        m[h]
                    }
                } catch (v) {
                }
                f.text && (g.push(f), f.end && !e && (g.push({begin: f.end, text: ""}), delete f.end))
            }
...
(function (h) {
    var k = h.utils, b = h.events, a = b.state, e = window.clearInterval, g = !0, c = !1;
    h.html5.video = function (d, f) {
        ...
        function E() {
            if (O) {
                ...
                1 <= a && e(W);
                a != X && (X = a, h(b.JWPLAYER_MEDIA_BUFFER, {bufferPercent: Math.round(100 * X)}))
            }
        }

        function z(a) {
            h("fullscreenchange",
                {target: a.target, jwstate: ya})
        }

        f = f || "";
        var q = k.isMSIE(), H = k.isMobile(), J = k.isSafari(), C = {
                abort: m,
                canplay: u,
                canplaythrough: m,
                ...
                error: function () {
                    O && (k.log("Error playing media: %o", d.error), h(b.JWPLAYER_MEDIA_ERROR, {message: "Error loading media: File could not be played"}),
                        l(a.IDLE))
                },
                loadeddata: m,
                loadedmetadata: u,
            ...
            t, G, A = c, L, I = 0, P = c, x = a.IDLE, Y, W = -1, X = -1, O = c, V, Z = -1, ha = k.isAndroidNative(), ja = k.isIOS(7), Ta = [], ia = c, ya = null, Q = k.extend(this, new b.eventdispatcher(f));
        Q.load = function (a) {
            if (O) {
                V = a.sources;
                0 > Z && (Z = 0);
                ...
                (c = p(V)) && Q.sendEvent(b.JWPLAYER_MEDIA_LEVELS, {levels: c, currentQuality: Z});
        ...
        Q.audioMode = function () {
            if (!V)return c;
            var a = V[0].type;
            return "oga" == a || "aac" == a || "mp3" == a || "vorbis" ==
                a
        };
...
(function (h, k) {
    ...
    var e = h.jwplayer, g = e.utils, c = e.events, d = c.state, f = new g.scriptloader(h.location.protocol + "//www.youtube.com/iframe_api"), D = g.isMobile(), m = g.isSafari();
    ...
    e.html5.youtube = function (a) {
        ...
        function n(b) {
            ...
            L = b;
            clearInterval(W);
            b !== d.IDLE && (W = setInterval(B, 250), b === d.PLAYING ? g.css("#" + a + " .jwcontrols", {display: ""}) : b === d.BUFFERING && y());
        ...
        function y() {
            var a = 0;
            t && t.getVideoLoadedFraction && (a =
                Math.round(100 * t.getVideoLoadedFraction()));
            I !== a && (I = a, r.sendEvent(c.JWPLAYER_MEDIA_BUFFER, {bufferPercent: a}))
        }

        function p() {
            var a = {duration: t.getDuration(), width: G.clientWidth, height: G.clientHeight};
        ...
        function C(a) {
            ...
            if (t)if (t.getPlayerState)if (t.getVideoData().video_id !== c) {
                ...
                var b = t.getPlayerState(), d = K.PlayerState;
                (b === d.UNSTARTED || b === d.CUED) && q()
            } else 0 < t.getCurrentTime() && t.seekTo(0), p(); else Y = function () {
                r.load(a)
            }; else x = function () {
                if (!c)throw{
                    name: "YouTubeID",
                ...
                if (!G.parentNode)throw{name: "YouTubeVideoLayer", message: "YouTube iFrame removed from DOM"};
                var a = {
                    height: "100%",
                    width: "100%",
                    videoId: c,
                    ...
                    events: {onReady: w, onStateChange: l, onPlaybackQualityChange: E, onError: z}
                };
                r.setVisibility(!0);
                t = new K.Player(G, a);
                G = t.getIframe();
        ...
        var r = g.extend(this, new c.eventdispatcher("html5.youtube")),
            K = h.YT, t = null, G = k.createElement("div"), A, L = d.IDLE, I = -1, P = !1, x = null, Y = null, W = -1, X = -1, O = !1, V = D || m, Z = !0;
        ...
        r.setVisibility = function (a) {
            a ? (g.css.style(G, {display: "block"}), g.css.style(A, {
                visibility: "visible",
                opacity: 1
        ...
        r.getQualityLevels = function () {
            if (t) {
                var a = [];
                if (t.getAvailableQualityLevels)for (var c = t.getAvailableQualityLevels(), b = c.length; b--;)a.push({label: c[b]});
                return a
            }
        };
...
(function (h) {
    var k = h.utils, b = k.css, a = h.events, e = 80, g = 30;
    h.html5.adskipbutton = function (c, d, f, h) {
        ...
        function j(a) {
            ...
            c.textAlign = "center";
            c.font = "Bold 12px Sans-Serif";
            a === h && (d -= q.width, c.drawImage(H,
                p.width - (p.width - c.measureText(h).width) / 2 - 4, (g - q.height) / 2));
            c.fillText(a, d, b + 4)
        }
        ...
        var y, p, w = -1, l = !1, E, z = 0, q, H, J = !1, C = k.extend(this, new a.eventdispatcher);
        C.updateSkipTime = function (a, c) {
            s(a, c);
            0 <= w && (b.style(y, {visibility: E ? "visible" : "hidden"}), 0 < w - a ? (m(a), l && (l = !1, y.style.cursor = "default")) : l || (l || (l = !0, y.style.cursor = "pointer"), J ? j() : u()))
        };
    ...
    b(".jwskip", {
        ...
        width: e, height: g, right: 10
    });
    b(".jwskipimage", {position: "relative", display: "none"})
})(window.jwplayer);
(function (h) {
    var k = h.html5, b = h.utils, a = h.events, e = a.state, g = h.parsers, c = b.css, d = b.isAndroid(4, !0), f = "playing", D = document;
    k.captions = function (c, k) {
        ...
        function j() {
            var a = q.offsetHeight, c = q.offsetWidth;
        ...
        function z() {
            for (var a = [{label: "Off"}], c = 0; c < t.length; c++)a.push({label: t[c].label});
            return a
        }
        ...
        var q, H = {
            ...
            fontWeight: "normal",
            textDecoration: "none"
        }, C, r, K, t = [], G = 0, A = -1, L = 0, I = !1, P = new a.eventdispatcher;
        b.extend(this, P);
        this.element = function () {
            return q
        };
        ...
        c.jwAddEventListener(a.JWPLAYER_PLAYLIST_ITEM, function () {
            ...
            L = 0;
            if (!d) {
                for (j = 0; j < f.length; j++)if (h = f[j].file)f[j].label || (f[j].label = j.toString()),
                    t.push(f[j]), n(t[j].file, j);
        ...
        c.jwAddEventListener(a.JWPLAYER_READY, function () {
            ...
            C = new h.html5.captions.renderer(J,
                q);
            p(!1)
        });
...
(function (h) {
    ...
    h.html5.captions.renderer = function (a, e) {
        ...
        function c() {
            if ("visible" === n) {
                var c = m.clientWidth, d = Math.pow(c / 400, 0.6), e = a.fontSize * d;
                b(v, {
                    maxWidth: c + "px",
                ...
                a.windowOpacity && b(s, {padding: Math.round(5 * d) + "px", borderRadius: Math.round(5 * d) + "px"});
                b(m,
                    {visibility: n})
            }
        }
        ...
        function f(a, c, b) {
            ...
            "dropshadow" === a ? c.textShadow = "0 2px 1px " + b : "raised" === a ? c.textShadow = "0 0 5px " + b + ", 0 1px 5px " + b + ", 0 2px 5px " + b : "depressed" === a ? c.textShadow = "0 -2px 1px " + b : "uniform" === a && (c.textShadow = "-2px 0 1px " + b + ",2px 0 1px " + b + ",0 -2px 1px " + b + ",0 2px 1px " + b + ",-1px 1px 1px " + b + ",1px 1px 1px " + b + ",1px -1px 1px " +
            b + ",1px 1px 1px " + b)
        }

        var D, m, s, v, u, j, n = "visible", B = -1;
        this.hide = function () {
            clearInterval(B);
            b(m, {display: "none"})
        };
        ...
        var y = a.fontOpacity, p = a.windowOpacity, w = a.edgeStyle, l = a.backgroundColor, E = {display: "inline-block"}, z = {
...
(function (h) {
    ...
    var b = h.html5, a = h.utils, e = h.events, g = e.state, c = a.css, d = a.transitionStyle, f = a.isMobile(), D = a.isAndroid(4, !0), m = "button", s = "text", v = "slider", u = "none", j = "100%", n = !1, B = !0, y = null, p = "", w = {display: u}, l = {display: "block"}, E = {display: p}, z = "array", q = window, H = document;
    b.controlbar = function (d, C) {
        ...
        function Y() {
            ...
            c.style(R, {height: Ja, bottom: b, left: b, right: b, "max-width": ua ? p : la.maxwidth});
            c(W(".jwtext"), {
        ...
        function V(a, b, d, e) {
            b && b.src && (c(a, {
                width: b.width, background: "url(" +
                b.src + ") no-repeat center", "background-size": k(b)
        ...
        function ja(a) {
            R && F.alt && (void 0 ===
            a && (a = R.parentNode && 320 <= R.parentNode.clientWidth), a && !ma ? c.style(Va, E) : c.style(Va, w))
        }
        ...
        function Q() {
            fa && 2 < fa.length &&
            (ob && (clearTimeout(ob), ob = void 0), c.block(aa), oa.show(), Ka("cc", oa), ha("cc"))
        }
        ...
        function kb(c) {
            if (za) {
                var b = F[za].querySelector(".jwrail"), b = a.bounds(b), b = c.x / b.width;
                100 < b && (b = 100);
        ...
        function Oa(c) {
            var b = F.time.querySelector(".jwrail"), b = a.bounds(b);
            c = c.x / b.width;
            100 < c && (c = 100);
            d.jwGetState() != g.IDLE && (db.time(c),
                U.sendEvent(e.JWPLAYER_USER_ACTION))
        }
        ...
        function Qa(c) {
            if (za && !c.button) {
                var b = F[za].querySelector(".jwrail"), e = a.bounds(b), b = za, e = F[b].vertical ? (e.bottom - c.pageY) / e.height : (c.pageX - e.left) / e.width;
                "mouseup" == c.type ? ("time" == b && d.jwSeekDrag(n), F[b + "Rail"].className = "jwrail", cb(), db[b.replace("H", p)](e)) : ("time" == za ? Ga(e) : Ua(e), 500 < sa - pb && (pb = sa, db[za.replace("H",
                    p)](e)));
                return !1
            }
        }
        ...
        function Aa() {
            a.foreach(fb, function (a, b) {
                var d = {};
                "%" === b.position.toString().slice(-1) ? d.left = b.position : 0 < ra ? (d.left = (100 * b.position / ra).toFixed(2) + "%", d.display = null) : (d.left =
                    0, d.display = "none");
                c.style(b.element, d)
            })
        }
        ...
        function Ba(c, b, d, j) {
            if (f) {
                ...
                (new a.touch(b)).addEventListener(a.touchEvents.TAP, function () {
                    var a = d;
                    "cc" == j ? (2 == fa.length && (a = Fa), gb ? (M(), c.hide()) :
                    ...
                    a:{
                        ...
                        switch (g.type) {
                            case s:
                                B = void 0;
                                g = g.name;
                                var B = {}, q = T(("alt" == g ? "elapsed" : g) + "Background");
                                if (q.src) {
                                    var r = X();
                                    r.id = aa + "_" + g;
                            ...
                            case m:
                                if ("blank" != g.name) {
                                    g = g.name;
                                    q = B;
                                    if (!T(g + "Button").src || f && ("mute" == g || 0 === g.indexOf("volume")) || D && /hd|cc/.test(g))g = y; else {
                                        var B = X(), r = X(), l = void 0, l = rb, x = O(l.name);
                                        ...
                                        (q = Eb[g]) && V(W(".jw" +
                                        g + ".jwtoggle button"), T(q + "Button"), T(q + "ButtonOver"));
                                        g = F[g] = B
                                    }
                                    break a
                                }
                            ...
                            case v:
                                B = void 0;
                                l = g.name;
                                if (f && 0 === l.indexOf("volume"))B = void 0; else {
                                    g = X();
                                    var r = "volume" == l, G = l + ("time" == l ? "Slider" : p) + "Cap", q = r ? "Top" : "Left", B = r ? "Bottom" : "Right", x = O(G + q, y, n, n, r), z = O(G + B, y, n, n, r), K;
                                    K = l;
                                    var A = r, E = q, C = B, P = X(), Y = ["Rail", "Buffer", "Progress"], I = void 0, L = void 0;
                                    P.className = "jwrail";
                                    for (var J = 0; J < Y.length; J++) {
                                        var L = "time" == K ? "Slider" : p, ja = K + L + Y[J], M = O(ja, y, !A, 0 === K.indexOf("volume"), A), N = O(ja + "Cap" + E, y, n, n,
                                            A), Q = O(ja + "Cap" + C, y, n, n, A), R = T(ja + "Cap" + E), U = T(ja + "Cap" + C);
                                        if (M) {
                                            var S = X();
                                            ...
                                            c(W(".jwrailgroup." + Y[J]), {"min-width": A ? p : R.width + U.width});
                                            ...
                                            2 == J && (I = S);
                                            2 == J && !A ? (M = X(), M.className = "jwprogressOverflow", M.appendChild(S),
                                                F[ja] = M, P.appendChild(M)) : (F[ja] = S, P.appendChild(S))
                                        }
                                    }
                                    ...
                                    "time" == K && !f && (P.addEventListener("mousemove",
                                        Wa, n), P.addEventListener("mouseout", Xa, n));
                                    K = F[K + "Rail"] = P;
                                    P = T(G + q);
                                    G = T(G + q);
                                    ...
                                    F[l] = g;
                                    g.vertical = r;
                                    "time" == l ? (pa = new b.overlay(aa + "_timetooltip", $), ib = new b.thumbs(aa + "_thumb"), jb = H.createElement("div"), jb.className = "jwoverlaytext", sb = H.createElement("div"),
        ...
        function Za() {
            !tb && 1 < d.jwGetPlaylist().length &&
            (!H.querySelector("#" + d.id + " .jwplaylist") || d.jwGetFullscreen()) ? (c.style(F.next, E), c.style(F.prev, E)) : (c.style(F.next, w), c.style(F.prev, w))
        }
        ...
        function Na(a, b) {
            if (F[a]) {
                var d = F[a].vertical, e = a + ("time" === a ? "Slider" : p), f = 100 * Math.min(Math.max(0, b), 1) + "%", g = F[e + "Progress"], e = F[e + "Thumb"], j;
                g && (j = {}, d ? (j.height =
                    f, j.bottom = 0) : j.width = f, "volume" !== a && (j.opacity = 0 < b || za ? 1 : 0), c.style(g, j));
        ...
        function T(a) {
            var c = "controlbar", b = a;
            0 === a.indexOf("volume") && (0 === a.indexOf("volumeH") ? b = a.replace("volumeH", "volume") : c = "tooltip");
            return (a = $.getSkinElement(c, b)) ? a : {width: 0, height: 0, src: p, image: void 0, ready: n}
        }
        ...
        function ca(c) {
            c =
                (new h.parsers.srt).parse(c.responseText, !0);
        ...
        var $, rb = r("divider", "divider"), ta = {
            ...
            fontweight: "bold",
            layout: {
                left: {position: "left", elements: [r("play", m), r("prev", m), r("next", m), r("elapsed", s)]},
                center: {position: "center", elements: [r("time", v), r("alt", s)]},
                right: {
                    position: "right", elements: [r("duration", s), r("hd", m), r("cc",
                        m), r("mute", m), r("volume", v), r("volumeH", v), r("cast", m), r("fullscreen", m)]
                }
            }
        }, la, da, F, Ja, R, aa, ra, sa, ga, Pa, fa, Ia, Ha, ka = {}, wa, La, eb, Ya, pa, sb, ib, jb, nb, hb, na, ob, gb, oa, zb, ab = -1, ua = n, ma = n, tb = n, ub = n, za = y, pb = 0, fb = [], bb, Eb = {
            play: "pause",
            mute: "unmute",
            fullscreen: "normalscreen"
        }, mb = {play: n, mute: n, fullscreen: n}, yb = {
            play: function () {
        ...
        }, lb = {}, Va = [], U = a.extend(this, new e.eventdispatcher), xb, Ab, Fb = function (a) {
        ...
        xb = function (b) {
            ...
            if (bb) {
                if ((b =
                        bb.text) && b !== Ab)Ab = b, c.style(pa.element(), {width: 32 < b.length ? 160 : p})
        ...
        U.redraw = function (b) {
            ...
            (d = la.maxwidth | 0) && R.parentNode && a.isIE() && (!ua && R.parentNode.clientWidth > d + (la.margin | 0) ? c.style(R, {width: d}) : c.style(R, {width: p}));
            wa && c.style(wa.element(), {display: !ua && !ma ? "block" : u});
            c.style(F.hd, {display: !ua && !b && !ma && ga && 1 < ga.length && na ? p : u});
            c.style(F.cc, {display: !ua && !ma && fa && 1 < fa.length && oa ? p : u});
            Aa();
            c.unblock(aa);
            U.visible && (b = T("capLeft"), d = T("capRight"), b = {
                left: Math.round(a.parseDimension(Ma.left.offsetWidth) + b.width),
                right: Math.round(a.parseDimension(Ma.right.offsetWidth) +
                d.width)
            }, c.style(Ma.center, b))
        };
        ...
        U.adMode = function (a) {
            if (void 0 !== a && a !== tb) {
                tb = !!a;
                if (a) {
                    var b = Va, d = b.indexOf(F.elapsed);
                    -1 < d && b.splice(d, 1);
                    b = Va;
            ...
            a.foreach(b, function (a, b) {
                if (b.text) {
                    ...
                    if (/^[\d\.]+%?$/.test(c.toString())) {
                        var e = O("timeSliderCue"), f = F.timeSliderRail, j = {position: c, text: d, element: e};
        ...
        c.block(aa + "build");
        Y();
        var Bb = O("capLeft"), Cb = O("capRight"), Db = O("background", {
            position: "absolute",
        ...
        d.jwAddEventListener(e.JWPLAYER_PLAYER_STATE, function (a) {
            switch (a.newstate) {
                ...
                case g.PLAYING:
                    F.timeSliderThumb &&
                    c.style(F.timeSliderThumb, {opacity: 1});
                    ia("play", B);
                    break;
                case g.PAUSED:
                    za || ia("play", n);
                    break;
                case g.IDLE:
                    ia("play", n), F.timeSliderThumb && c.style(F.timeSliderThumb, {opacity: 0}), F.timeRail && (F.timeRail.className = "jwrail"), va(0), K({
                        position: 0,
                        duration: 0
                    })
            }
        ...
        d.jwAddEventListener(e.JWPLAYER_PLAYLIST_ITEM, function (b) {
            if (!ma) {
                ...
                var c = n, e = F.timeSliderRail;
                a.foreach(fb, function (a, b) {
                    e.removeChild(b.element)
                });
                fb.length = 0;
                if (a.typeOf(b) == z && !f)for (var j = 0; j < b.length; j++)if (!c &&
                    (b[j].file && b[j].kind && "thumbnails" == b[j].kind.toLowerCase()) && (ib.load(b[j].file), c = B), b[j].file && b[j].kind && "chapters" == b[j].kind.toLowerCase()) {
                    var g = b[j].file;
        ...
        d.jwAddEventListener(e.JWPLAYER_CAPTIONS_LIST, function (a) {
            ...
            if (!ma && fa && 1 < fa.length && oa) {
                c.style(F.cc, E);
                oa.clearOptions();
                for (var b = 0; b < fa.length; b++)oa.addOption(fa[b].label,
                    b);
                L(a)
            } else c.style(F.cc, w);
            ba()
    ...
    c("span.jwcontrolbar", {position: "absolute", margin: "auto", opacity: 0, display: u});
    ...
    c("span.jwcontrolbar buttoncontainer,span.jwcontrolbar button",
        {display: "inline-block", height: j, border: u, cursor: "pointer"});
    ...
    c("span.jwcontrolbar .jwtime", {position: "absolute", height: j, width: j, left: 0});
    c("span.jwcontrolbar .jwthumb", {position: "absolute", height: j, cursor: "pointer"});
    c("span.jwcontrolbar .jwrail", {position: "absolute", cursor: "pointer"});
    c("span.jwcontrolbar .jwrailgroup",
        {position: "absolute", width: j});
    ...
    c("span.jwcontrolbar .jwalt", {position: "absolute", left: 0, right: 0, "text-align": "left"}, B);
    ...
    c("span.jwcontrolbar .jwprogressOverflow", {position: "absolute", overflow: "hidden"});
...
(function (h) {
    var k = h.utils, b = h.events, a = b.state, e = h.playlist, g = !0, c = !1;
    h.html5.controller = function (d, f) {
        ...
        var l = c, E = -1, z = c, q, H = c, J, C = [], r = k.extend(this, new b.eventdispatcher(d.id, d.config.debug));
        this.play = p(v);
        this.pause = p(j);
        ...
        this.playerReady = function (a) {
            if (!l) {
                ...
                r.sendEvent(h.events.JWPLAYER_PLAYLIST_LOADED, {playlist: h(d.id).getPlaylist()});
                r.sendEvent(h.events.JWPLAYER_PLAYLIST_ITEM, {index: d.item});
                s();
                d.autostart && !k.isMobile() &&
                v();
...
(function (h) {
    var k = h.html5, b = h.utils, a = h.events, e = a.state, g = b.css, c = b.isMobile(), d = document, f = ".jwpreview", D = !0, m = !1;
    k.display = function (h, v) {
        function u(d) {
            if (V && (h.jwGetControls() || h.jwGetState() == e.PLAYING))V(d); else if ((!c || !h.jwGetControls()) && O.sendEvent(a.JWPLAYER_DISPLAY_CLICK), h.jwGetControls()) {
                ...
                var f = b.bounds(z.parentNode.querySelector(".jwcontrolbar")), g = b.bounds(z), j = f.left - 10 - g.left, B = f.left + 30 -
                    g.left, t = g.bottom - 40, r = g.bottom, q = f.right - 30 - g.left, f = f.right + 10 - g.left;
        ...
        function n(a) {
            C != a ? (C &&
            E(f, m), (C = a) ? (a = new Image, a.addEventListener("load", p, m), a.src = C) : (g("#" + z.id + " " + f, {"background-image": ""}), E(f, m), r = K = 0)) : C && !I && E(f, D);
            y(h.jwGetState())
        }
        ...
        var z, q, H, J, C, r, K, t = m, G = {}, A = m, L = m, I, P, x, Y, W, X = b.extend({
            showicons: D, bufferrotation: 45, bufferinterval: 100,
            fontcolor: "#ccc", overcolor: "#fff", fontsize: 15, fontweight: ""
        }, h.skin.getComponentSettings("display"), v), O = new a.eventdispatcher, V, Z;
        b.extend(this, O);
        this.clickHandler = u;
        var ha;
        ...
        this.show = function (a) {
            if (x && (a || (Y ? Y : h ? h.jwGetState() : e.IDLE) != e.PLAYING))clearTimeout(P),
                P = void 0, z.style.display = "block", x.show(), I = !1
        };
        this.hide = function () {
            x && (x.hide(), I = !0)
        };
        ...
        h.jwAddEventListener(a.JWPLAYER_PLAYLIST_ITEM, function () {
            A = m;
            G.error && G.error.setText();
            var a = (J = h.jwGetPlaylist()[h.jwGetPlaylistIndex()]) ?
                J.image : "";
            W = void 0;
            n(a)
        });
    ...
    g(".jwdisplay", {position: "absolute", width: "100%", height: "100%", overflow: "hidden"});
    g(".jwdisplay " + f, {
        position: "absolute",
        width: "100%",
        height: "100%",
...
(function (h) {
    var k = h.utils, b = k.css, a = document, e = "none", g = "100%";
    h.html5.displayicon = function (c, d, f, D) {
        ...
        function s(a, c, e, j, f) {
            ...
            g.src ? (j = k.extend({}, j), 0 < c.indexOf("Icon") && (C = g.width | 0), j.width = g.width, j["background-image"] = "url(" + g.src + ")", j["background-size"] = g.width + "px " + g.height + "px", j["float"] = "none", f = k.extend({}, f), g.overSrc && (f["background-image"] =
                "url(" + g.overSrc + ")"), k.isMobile() || b("#" + d.id + " .jwdisplay:hover " + e, f), b.style(y, {display: "table"})) : b.style(y, {display: "none"});
            j && b.style(a, j);
            J = g
        }
        ...
        function j() {
            ...
            var a = "px " + g, c = Math.ceil(Math.max(J.width, k.bounds(y).width -
            l.width - w.width)), a = {"background-size": [w.width + a, c + a, l.width + a].join(", ")};
        ...
        var B = d.skin, y, p, w, l, E, z, q, H = {}, J, C = 0, r = -1, K = 0;
        this.element = function () {
            return y
        };
        this.setText = function (b) {
            ...
            c.height = "0";
            c.display = "block";
            if (b)for (; 2 < Math.floor(z.scrollHeight / a.defaultView.getComputedStyle(z, null).lineHeight.replace("px", ""));)z.innerHTML =
                z.innerHTML.replace(/(.*) .*$/, "$1...");
            c.height = "";
            c.display = "";
            u()
        };
        ...
        z = m("jwtext", y, f, D);
        q = m("jwicon", y);
        d.jwAddEventListener(h.events.JWPLAYER_RESIZE,
            j);
        L();
        u()
    };
...
(function (h) {
    var k = h.html5, b = h.utils, a = b.css, e = b.bounds, g = ".jwdockbuttons", c = document, d = "none", f = "block";
    k.dock = function (h, m) {
        function s(a) {
            return !a || !a.src ? {} : {
        ...
        function n(a) {
            return (a = w.getSkinElement("dock",
        ...
        var y = b.extend({}, {
            ...
            iconalphaover: 1,
            margin: 8
        }, m), p = h.id + "_dock", w = h.skin, l = 0, E = {}, z = {}, q, H, J, C = this;
        C.redraw = function () {
            e(q)
        };
        C.element = function () {
        ...
        C.addButton = function (c, d, f, g) {
            if (!E[g]) {
                var h = j("div", "divider", H), t = j("div", "button", H), r = j("div", null, t);
                r.id = p + "_" + g;
                r.innerHTML = "\x26nbsp;";
                ...
                if (d) {
                    ...
                    if (!b.isMobile()) {
                        ...
                        t.addEventListener("mouseover", function () {
                            ...
                            c.offsetX(0);
                            j = e(q);
                            a("#" + c.element().id, {left: d.left - j.left + d.width / 2});
                            d = e(c.element());
        ...
        q.appendChild(H);
        q.id = p;
        var r = n("button"), K = n("buttonOver"), t = n("buttonActive");
        r && (a(u(), {
            height: r.height,
            padding: y.margin
        }), a(g, {height: r.height}), a(u("div.button"), b.extend(s(r), {
            width: r.width,
            cursor: "pointer",
            border: d
        })), a(u("div.button:hover"), s(K)), a(u("div.button:active"), s(t)), a(u("div.button\x3ediv"), {opacity: y.iconalpha}), a(u("div.button:hover\x3ediv"), {opacity: y.iconalphaover}), a(u("div.button:active\x3ediv"), {opacity: y.iconalphaactive}), a(u(".jwoverlay"), {top: y.margin + r.height}), v("capLeft", H), v("capRight", H), v("divider"));
        setTimeout(function () {
            e(q)
        })
    };
...
(function (h) {
    var k = h.html5, b = h.utils, a = h.events, e = a.state, g = h.playlist;
    k.instream = function (c, d, f, h) {
        ...
        }, H, J, C, r, K, t, G, A, L, I, P = -1, x = b.extend(this, new a.eventdispatcher);
        ...
        x.init = function () {
            ...
            t.addEventListener(a.JWPLAYER_MEDIA_BUFFER_FULL,
                u);
        ...
        x.load = function (d, j) {
            if (b.isAndroid(2.3))m({
                ...
                B(a.JWPLAYER_PLAYLIST_ITEM, {index: E}, !0);
                var h = 10 + b.bounds(L.parentNode).bottom -
                    b.bounds(G.element()).top;
                ...
                A.setAlternateClickHandler(function (d) {
                    ...
                    d.hasControls ? I.state === e.PAUSED ?
                        x.jwInstreamPlay() : x.jwInstreamPause() : b.isAndroid() && I.state !== e.PAUSED && x.jwInstreamPause()
                });
        ...
        x.jwInstreamDestroy = function (c) {
            if (I) {
                ...
                A &&
                (J && J.parentElement && J.parentElement.removeEventListener("click", A.clickHandler), A.revertAlternateClickHandler());
                B(a.JWPLAYER_INSTREAM_DESTROYED, {reason: c ? "complete" : "destroyed"}, !0);
                r == e.PLAYING && J.play();
        ...
        x.jwStop = function () {
            "true" == q.controlbarstoppable.toString().toLowerCase() && (c.jwInstreamDestroy(!1,
                x), c.jwStop())
        };
        x.jwSeek = function (a) {
...
(function (h) {
    var k = h.utils, b = k.css, a = h.events.state, e = h.html5.logo = function (g, c) {
        function d(b) {
        ...
        var f = g, D = f.id + "_logo", m, s, v = e.defaults, u = !1;
        this.resize = function () {
        };
        this.element = function () {
            return s
        ...
        if ("o" == j || "f" == j)v.link = "http://www.longtailvideo.com/jwpabout/?a\x3dl\x26v\x3d" + h.version + "\x26m\x3dh\x26e\x3d" + j;
        m = k.extend({}, v, c);
        ...
        s.id = D;
        if (m.file) {
            var v = /(\w+)-(\w+)/.exec(m.position), j = {}, n = m.margin;
    ...
    e.defaults = {prefix: k.repo(), file: "logo.png", linktarget: "_top", margin: 8, hide: !1, position: "top-right"};
    b(".jwlogo", {cursor: "pointer", position: "absolute"})
})(jwplayer);
(function (h) {
    var k = h.html5, b = h.utils, a = b.css;
    k.menu = function (e, g, c, d) {
        ...
        var v = d, u = new k.overlay(g + "_overlay", c);
        d = b.extend({
        ...
        var y = s("menuTop" + e);
        e = s("menuOption");
        var p = s("menuOptionOver"), w = s("menuOptionActive");
        if (y && y.image) {
            var l = new Image;
            l.src = y.src;
            l.width = y.width;
        ...
        })), a(y + ":hover", b.extend(f(p), {color: d.overcolor})), a(y + ".active", b.extend(f(w), {color: d.activecolor})));
        u.setContents(j)
    };
    a("." + "jwmenu jwoption".replace(/ /g, " ."), {cursor: "pointer", "white-space": "nowrap", position: "relative"})
})(jwplayer);
(function (h) {
    var k = h.html5, b = h.utils, a = h.events;
    k.model = function (e, g) {
        function c(a) {
            var b = u[a.type];
            if (b && b.length) {
                for (var c = !1, e = 0; e < b.length; e++) {
                    var j = b[e].split("-\x3e"), g = j[0], j = j[1] || g;
                    d[j] !== a[g] && (d[j] = a[g], c = !0)
                }
        ...
        var d = this, f, D = {html5: g || new k.video(null, "default")}, m = b.getCookies(), s = {
            controlbar: {},
            display: {}
        }, v = {
            autostart: !1,
        ...
        d.setPlaylist = function (c) {
            ...
            0 === d.playlist.length ? d.sendEvent(a.JWPLAYER_ERROR, {message: "Error loading playlist: No playable sources found"}) : (d.sendEvent(a.JWPLAYER_PLAYLIST_LOADED, {playlist: h(d.id).getPlaylist()}),
        ...
        var j = d, n = b.extend({}, v, m, e);
        b.foreach(n, function (a, c) {
            n[a] = b.serialize(c)
        });
        j.config = n;
        b.extend(d, {id: e.id, state: a.state.IDLE, duration: -1, position: 0, buffer: 0}, d.config);
        d.playlist = [];
        d.setItem(0)
    }
})(jwplayer);
(function (h) {
    var k = h.utils, b = k.css, a = k.transitionStyle, e = "top", g = "bottom", c = "right", d = "left", f = document, D = {
        fontcase: void 0,
        fontcolor: "#ffffff",
        fontsize: 12,
        fontweight: void 0,
    ...
    h.html5.overlay = function (a, h, v) {
        ...
        function n(a, c) {
            var d;
            d = (d = l.getSkinElement("tooltip", a)) ? d : {width: 0, height: 0, src: "", image: void 0, ready: !1};
            var e = j(c, z);
            b.style(e, B(d));
            return [e, d]
        }
        ...
        function y(a, j) {
            j || (j = "");
            var f = n("cap" + a + j, "jwborder jw" + a + (j ? j : "")), h = f[0], f = f[1], q = k.extend(B(f), {
            ...
            j && (h[j] = f[j], h[a] =
                0, q[a] = f[a], q[j] = 0, b(u("jw" + a), h), b(u("jw" + j), q), C[a] = f[a], C[j] = f[j])
        }

        var p = this, w = a, l = h, E = v, z, q, H, J;
        ...
        p.offsetX = function (a) {
            a = Math.round(a);
            var c = z.clientWidth;
            0 !== c && (b.style(z, {"margin-left": Math.round(-c / 2) + a}), b.style(J, {"margin-left": Math.round(-H.width / 2) - a}));
            return c
        };
        ...
        H = h[1];
        b.style(J, {
            position: "absolute", bottom: E ? void 0 : 0, top: E ? 0 :
                void 0, width: H.width, height: H.height, left: "50%"
        });
        y(e, d);
        y(g, d);
        y(e, c);
        ...
        b.style(h[0], {left: C.left, right: C.right, top: C.top, bottom: C.bottom});
        q = j("jwcontents", z);
        b(u("jwcontents") + " *", {
            color: a.fontcolor,
        ...
        b.style(z, {padding: C.top + 1 + "px " + C.right + "px " + (C.bottom + 1) + "px " + C.left + "px"});
        p.showing = !1
    };
    b(".jwoverlay", {position: "absolute", visibility: "hidden", opacity: 0});
    b(".jwoverlay .jwcontents", {position: "relative", "z-index": 1});
    b(".jwoverlay .jwborder", {position: "absolute", "background-size": "100% 100%"}, !0);
    b(".jwoverlay .jwback", {position: "absolute", "background-size": "100% 100%"});
    a(".jwoverlay", "opacity .25s, visibility .25s")
})(jwplayer);
(function (h) {
    var k = h.html5, b = h.utils;
    k.player = function (a) {
        function e() {
        ...
        function g(a) {
            var c = {description: a.description, file: a.file, image: a.image, mediaid: a.mediaid, title: a.title};
...
(function (h) {
    var k = {
        ...
        fontsize: 11,
        titlesize: 13
    }, b = jwplayer.events, a = jwplayer.utils, e = a.css, g = a.isMobile(), c = document;
    h.playlistcomponent = function (d, f) {
        ...
        var v = d, u = v.skin, j = a.extend({}, k, v.skin.getComponentSettings("playlist"), f), n, B, y, p, w = -1, l, E, z = 76, q = {
            background: void 0,
            divider: void 0,
            item: void 0,
            itemOver: void 0,
        ...
        e(D("jwlist"), {"background-image": q.background ? " url(" + q.background.src + ")" : ""});
        e(D("jwlist *"), {
            color: j.fontcolor,
        ...
        e(D("jwplaylistimg"), {height: K, width: r, margin: C ? C + "0 " + C + C : "0 5px 0 0"});
        e(D("jwlist li"), {
        ...
        g || (e(D("jwlist li:hover"), C), e(D("jwlist li:hover .jwtitle"), {color: j.titleovercolor}), e(D("jwlist li:hover .jwdescription"), {color: j.overcolor}));
        ...
        v.jwAddEventListener(b.JWPLAYER_PLAYLIST_LOADED, function () {
            ...
            if (y = c) {
                ...
                for (b = 0; b < y.length; b++) {
                    var f = b, c = y[f], d = m("li", "jwitem"), j = void 0;
                    d.id = p.id + "_item_" + f;
                    ...
                    j && !H && (e("#" + d.id + " .jwplaylistimg",
                        {"background-image": j}), d.appendChild(f));
        ...
        v.jwAddEventListener(b.JWPLAYER_PLAYLIST_ITEM, function (a) {
            0 <=
            w && (c.getElementById(p.id + "_item_" + w).className = "jwitem", w = a.index);
...
(function (h) {
    ...
    var b = jwplayer.utils, a = b.touchEvents, e = b.css, g = document, c = window;
    h.playlistslider = function (d, f, h, k) {
        ...
        function u(a) {
            return (a =
                l.getSkinElement("playlist", a)) ? a : {width: 0, height: 0, src: void 0}
        }
        ...
        var l = f, E = k, z, q, H, J, C = 0, r, K;
        f = b.isMobile();
        var t = !0, G, A, L, I, P, x, Y, W, X;
        this.element = function () {
            return z
        };
            ...
            function () {
                ...
                X = setTimeout(function () {
                    if (E && E.clientHeight) {
                        ...
                        0 > a && (a = 0);
                        1 < a ? t = !1 : (t = !0, e(s("jwthumb"), {height: Math.max(q.clientHeight * a, P.height + x.height)}));
...
(function (h) {
    var k = jwplayer.utils, b = k.css, a = document, e = "none";
    h.rightclick = function (b, c) {
        ...
        var D, m = k.extend({
            aboutlink: "http://www.longtailvideo.com/jwpabout/?a\x3dr\x26v\x3d" + h.version + "\x26m\x3dh\x26e\x3do",
        ...
        D.oncontextmenu = function (a) {
            if (!s) {
                ...
                var b = null != a.target ? a.target : a.srcElement, c = k.bounds(D), b = k.bounds(b);
                v.style.display = e;
    ...
    b(".jwclick_item", {padding: "8px 21px", "text-align": "left", cursor: "pointer"}, !0);
    b(".jwclick_item:hover", {"background-color": "#595959", color: "#FFF"}, !0);
    b(".jwclick_item a", {"text-decoration": e, color: "#000"},
        !0);
    b(".jwclick hr", {width: "100%", padding: 0, margin: 0, border: "1px #e9e9e9 solid"}, !0)
})(jwplayer.html5);
(function (h) {
    var k = h.html5, b = h.utils, a = h.events, e = 2, g = 4;
    k.setup = function (c, d) {
        ...
        var u = d, j = {}, n, B = new a.eventdispatcher, y = !1, p, w = [{
            ...
            name: 3, method: function () {
                ...
                "array" === a ? (a = new h.playlist(c.config.playlist), c.setPlaylist(a), 0 === c.playlist.length || 0 === c.playlist[0].sources.length ? v("Error loading playlist: No playable sources found") :
                    j[3] = !0) : v("Playlist type not supported: " + a)
            }, depends: 1
        }, {
            name: g, method: function () {
...
(function (h) {
    var k = jwplayer.utils, b = k.foreach, a = "Skin formatting error";
    h.skinloader = function (e, g, c) {
            ...
            if (0 === a.length)j(u);
                ...
                if ((d = f(a[c], "settings")[0]) && 0 < d.childNodes.length) {
                    ...
                    for (e = 0; e < d.length; e++) {
                        var g = d[e].getAttribute("name"), h = d[e].getAttribute("value");
            ...
            w || (y = setInterval(function () {
                ...
                b(u, function (c, d) {
                    "properties" != c && b(d.elements, function (b) {
                        (u[v(c)] ?
                            u[v(c)].elements[v(b)] : null).ready || (a = !1)
                    })
                });
        ...
        function s(a, b) {
            ...
            if (0 !== e.indexOf("data:image/png;base64,"))var f = k.getAbsolutePath(p), e = [f.substr(0, f.lastIndexOf("/")), b, e].join("/");
            u[b].elements[d] = {height: 0, width: 0, src: "", ready: !1, image: c};
            c.onload = function () {
                var a = b, e = u[v(a)] ? u[v(a)].elements[v(d)] : null;
                e ? (e.height = Math.round(c.height / E * l), e.width = Math.round(c.width / E * l), e.src = c.src,
                    e.ready = !0, m()) : k.log("Loaded an image for a missing element: " + a + "." + d)
            };
            c.onerror = function () {
                w = !0;
                m();
...
(function (h) {
    ...
    h.html5.thumbs = function (e) {
        ...
        var f, D, m, s, v, u = {}, j, n = new b.eventdispatcher;
        k.extend(this, n);
                ...
                a:{
                    ...
                    if (f && f !== v) {
                        ...
                        if (0 < f.indexOf("#xywh"))try {
                            var h = /(.+)\#xywh=(\d+),(\d+),(\d+),(\d+)/.exec(f), f = h[1];
...
(function (h) {
    var k = h.jwplayer, b = k.html5, a = k.utils, e = k.events, g = e.state, c = a.css, d = a.bounds, f = a.isMobile(), D = a.isIPad(), m = a.isIPod(), s = document, v = "aspectMode", u = ["fullscreenchange", "webkitfullscreenchange", "mozfullscreenchange", "MSFullscreenChange"], j = !0, n = !j, B = "hidden", y = "none", p = "block";
    b.view = function (w, l) {
        function E(b) {
        ...
        function q(a) {
            var b;
            b = a.ctrlKey || a.metaKey ? !1 : l.controls ?
                !0 : !1;
            if (!b)return !0;
            M.adMode() || (ia(), A());
            b = k(w.id);
        ...
        function C() {
            var a = d(N), b = Math.round(a.width), c = Math.round(a.height);
        ...
        function r(a) {
            a &&
            (a.element().addEventListener("mousemove", I, n), a.element().addEventListener("mouseout", P, n))
        }
        ...
        function O(b, d, e) {
            var f = N.className,
                g, h, k = w.id + "_view";
            c.block(k);
            if (e = !!e)f = f.replace(/\s*aspectMode/, ""), N.className !== f && (N.className = f), c.style(N, {display: p}, e);
            ...
            if (la && g && ("right" ==
                h || "bottom" == h))la.redraw(), f = {display: p}, e = {}, f[h] = 0, e[h] = g, "right" == h ? f.width = g : f.height = g, c.style(Ra, f), c.style(Aa, e);
            Z(b, d);
            c.unblock(k)
        }
        ...
        function ja(b, d) {
            ...
            d ? (a.addClass(b, "jwfullscreen"), c.style(s.body,
                {"overflow-y": B}), A()) : c.style(s.body, {"overflow-y": ""});
            M && M.redraw();
            S && S.redraw();
            ea && ea.redraw();
            Z();
        ...
        function Qa(a) {
            if (l.getVideo().isCaster)S && (S.show(), S.hidePreview(n)), c.style(ba, {
                visibility: B,
                opacity: 0
            }), M && (M.show(), M.hideFullscreen(j)); else {
                switch (a) {
                    case g.PLAYING:
                        R = l.getVideo().isCaster !== j ? null : j;
                        (T ? Ga : l).getVideo().audioMode() ? (Ea(n), S.hidePreview(da), S.setHiding(j), M && (Da(), M.hideFullscreen(j)), Q()) :
                            (Ea(j), Z(), S.hidePreview(j), M && M.hideFullscreen(!l.getVideo().supportsFullscreen()));
                        break;
                    case g.IDLE:
                        Ea(n);
        ...
        var N, Aa, qa, qb, Ra, Ba = -1, $a = f ? 4E3 : 2E3, ba, Za, Ka, va, Na, Ua, Ga, T = n, M, S, ca, ea, $, rb = a.extend({}, l.componentConfig("logo")), ta, la, da, F = n, Ja = n, R = null, aa, ra, sa = -1, ga = n, Pa, fa, Ia =
            !1, Ha = !1, ka = a.extend(this, new e.eventdispatcher);
        this.getCurrentCaptions = function () {
        ...
        this.setup = function (d) {
            if (!F) {
                ...
                w.jwAddEventListener(e.JWPLAYER_PLAYER_READY,
                    kb);
                ...
                w.jwAddEventListener(e.JWPLAYER_CAST_SESSION, function (a) {
                    ...
                    a.active ? (c.style(ta.element(), {display: "none"}),
                ...
                Oa({newstate: g.IDLE});
                f || (qa.addEventListener("mouseout", t, n), qa.addEventListener("mousemove",
                    L, n), a.isMSIE() && (ba.addEventListener("mousemove", L, n), ba.addEventListener("click", S.clickHandler)));
                r(M);
                r(ea);
                r($);
                c("#" + N.id + "." + v + " .jwaspect", {"margin-top": l.aspectratio, display: p});
                d = a.exists(l.aspectratio) ? parseFloat(l.aspectratio) : 100;
                q = l.playlistsize;
                c("#" + N.id + ".playlist-right .jwaspect", {"margin-bottom": -1 * q * (d / 100) + "px"});
                ...
                c("#" + N.id + ".playlist-bottom .jwaspect", {"padding-bottom": q + "px"});
                c("#" +
                N.id + ".playlist-bottom .jwplaylistcontainer", {width: "100%", height: q + "px", bottom: 0});
        ...
        this.setControls = function (a) {
            var b = l.controls, c = !!a;
            l.controls = c;
            c != b && (T ? a ? (Na.show(), Ua.show()) : (Na.hide(), Ua.hide()) : c ? Oa({newstate: w.jwGetState()}) : (Ca(), S && S.hide()), ka.sendEvent(e.JWPLAYER_CONTROLS, {controls: c}))
        };
        ...
        this.getSafeRegion = function () {
            ...
            M.showTemp();
            ea.showTemp();
            var b = d(Aa), c = b.top, e = T ? d(s.getElementById(w.id + "_instream_controlbar")) : d(M.element()), f = T ? n : 0 < ea.numButtons(), g = 0 === $.position().indexOf("top"), h = d($.element());
            f && (f = d(ea.element()), a.y = Math.max(0, f.bottom - c));
            g && (a.y =
                Math.max(a.y, h.bottom - c));
            a.width = b.width;
        ...
        this.destroy = function () {
            ...
            qa && (qa.removeEventListener("mousemove",
                L), qa.removeEventListener("mouseout", t));
        ...
        Pa = N.requestFullscreen || N.requestFullScreen || N.webkitRequestFullscreen ||
        N.webkitRequestFullScreen || N.webkitEnterFullscreen || N.webkitEnterFullScreen || N.mozRequestFullScreen || N.msRequestFullscreen;
        ...
        Ia = Pa && fa;
        l.aspectratio && (c.style(N, {display: "inline-block"}), N.className = N.className.replace("jwplayer", "jwplayer " + v));
        O(l.width, l.height);
    ...
    c(".jwplaylistcontainer", {position: "absolute", height: "100%", width: "100%", display: y});
    c(".jwinstream", {position: "absolute", top: 0, left: 0, bottom: 0, right: 0, display: "none"});
    c(".jwaspect", {display: "none"});
    c(".jwplayer." + v, {height: "auto"});
    c(".jwplayer.jwfullscreen", {
        width: "100%", height: "100%", left: 0, right: 0, top: 0, bottom: 0,
        "z-index": 1E3, margin: 0, position: "fixed"
    }, j);
    c(".jwplayer.jwfullscreen.jw-user-inactive", {cursor: "none", "-webkit-cursor-visibility": "auto-hide"});
    c(".jwplayer.jwfullscreen .jwmain", {left: 0, right: 0, top: 0, bottom: 0}, j);
    c(".jwplayer.jwfullscreen .jwplaylistcontainer", {display: y}, j);
    c(".jwplayer .jwuniform", {"background-size": "contain !important"});
    c(".jwplayer .jwfill", {"background-size": "cover !important", "background-position": "center"});
...
(function (h, k) {
    ...
    var c = h.utils, d = h.html5, f = h.events, D = f.state, m = c.css, s = {
    ...
    d.castDisplay = function (j) {
        ...
        v || (m(".jwplayer .jwcast-display", {
            ...
            "user-select": "none",
            cursor: "pointer"
        }), m(".jwcast-paused .jwcast-click-label", {color: "#7a7a7a", cursor: "default"}), v = !0);
        var w = k.getElementById(j + "_display_button"), l = a("div", "display"), E = a("div", ["pause", "button"]), z = a("div", ["play", "button"]), q = a("div", ["replay", "button"]), H = a("div", ["wheel", "button"]), J = a("div", "label"), C = a("span"), r = a("span", "name"), K = "#" + j + "_display.jwdisplay", t = -1, G = null, A = null, L = null, I = null;
        g(l, [H, E, z, q, J]);
        g(J, [C, r]);
        ...
        this.setState = function (a) {
            var b = "Casting on ";
            if (null === G)if ("connecting" === a)b = "Connecting to "; else if (a !== D.IDLE) {
        ...
        this.show =
            function () {
                m(K + " .jwpreview", {"background-size": "316px 176px !important", opacity: 0.6, "margin-top": -2});
        ...
        this.setSkipoffset = function (a, b) {
            if (null === A) {
                var e = k.getElementById(j + "_controlbar"), g = 10 + c.bounds(l).bottom - c.bounds(e).top;
        ...
        this.setCompanions = function (b) {
            var c, d, e, f = Number.MAX_VALUE, h = null;
            ...
            (b = h) ? (null === L && (L = a("div", "companion"), g(l, L)), b.width / b.height >
            u ? (c = 316, d = b.height * c / b.width) : (d = 176, c = b.width * d / b.height), m.style(L, {
        ...
        this.adChanged = function (b) {
            if (b.complete)A && A.reset(-1), G = null; else {
                ...
                c !== G && (m(K + " .jwpreview", {opacity: 0}), b.companions ? this.setCompanions(b.companions) : p(), b.clickthrough ? null === I && (I = a("div", "click-label"), I.innerText = "Click here to learn more \x3e",
                    g(l, I)) : y(), G = c, this.setState(b.newstate))
            }
        };
...
(function (h) {
    var k = jwplayer.utils.extend, b = h.logo;
    b.defaults.prefix = "";
...
(function (h) {
    var k = h.html5, b = k.model;
    k.model = function (a, e) {
        var g = new h.utils.key(a.key), c = new b(a, e), d = c.componentConfig;
        c.edition = function () {
            return g.edition()
        };
...
(function (h) {
    var k = jwplayer.utils.extend, b = h.rightclick;
    h.rightclick = function (a, e) {
        if ("free" == a.edition())e.aboutlink = "http://www.longtailvideo.com/jwpabout/?a\x3dr\x26v\x3d" + h.version + "\x26m\x3dh\x26e\x3df", delete e.abouttext; else {
            if (!e.aboutlink) {
                var g = "http://www.longtailvideo.com/jwpabout/?a\x3dr\x26v\x3d" + h.version + "\x26m\x3dh\x26e\x3d", c = a.edition();
                e.aboutlink = g + ("pro" == c ? "p" : "premium" == c ? "r" : "enterprise" == c ? "e" : "ads" == c ? "a" : "f")
            }
            e.abouttext ? e.abouttext += " ..." : (g = a.edition(), g = g.charAt(0).toUpperCase() +
            g.substr(1), e.abouttext = "About JW Player " + h.version + " (" + g + " edition)")
        }
        k(this, new b(a, e))
    }
})(jwplayer.html5);
(function (h) {
    var k = h.view;
    h.view = function (b, a) {
        var e = new k(b, a), g = e.setup, c = a.edition();
        e.setup = function (a) {
            g(a)
        };
